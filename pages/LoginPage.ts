...
export default class LoginPage extends BasePage {
    ...
    public async loginToApplcation(username=UserCredentials.STANDARD_USER, 
        ...
        url =ApplicationURL.BASE_URL) {
         ...
         //await this.validatePageURL(`${ApplicationURL.BASE_URL}inventory.html`); added in productPage
    ...
    public async validateErrorMessage(errorMessage: ErrorMessages){
        ...
        // await expect(this.errorMessage).toContainText(errorMessage.valueOf()); old
